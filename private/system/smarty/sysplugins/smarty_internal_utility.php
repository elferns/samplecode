 ...
 * SVN:         $Id: $
 *
 * This systemrary is free software; you can redistribute it and/or
 * modify it under the terms of the GNU Lesser General Public
 * License as published by the Free Software Foundation; either
 * version 2.1 of the License, or (at your option) any later version.
 *
 * This systemrary is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU
 * Lesser General Public License for more details.
 *
 * You should have received a copy of the GNU Lesser General Public
 * License along with this systemrary; if not, write to the Free Software
...
class Smarty_Internal_Utility {
    ...
    public static function testInstall(Smarty $smarty, &$errors=null)
    {
        ...
        if (!$_core_plugins_available) {
            $status = false;
            $message = "WARNING: Smarty's own systems/plugins is not available";
            if ($errors === null) {
                echo $message . ".\n";
        ...
        if (is_dir($source)) {
            ...
            if ($expected) {
                $status = false;
                $message = "FAILED: files missing from systems/sysplugins: ". join(', ', array_keys($expected));
                if ($errors === null) {
                    echo $message . ".\n";
                } else {
        ...
        if (is_dir($source)) {
            ...
            if ($expected) {
                $status = false;
                $message = "FAILED: files missing from systems/plugins: ". join(', ', array_keys($expected));
                if ($errors === null) {
                    echo $message . ".\n";
                } else {
