...
/**
 * set SMARTY_DIR to absolute path to Smarty systemrary files.
...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    public static function muteExpectedErrors()
    {
        /*
            ...
            Smarty desystemerately uses @filemtime() over file_exists() and filemtime() in some places. Reasons include
